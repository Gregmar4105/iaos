...
import { ArrowLeftIcon, CalendarIcon, MapPinIcon, PlaneIcon } from 'lucide-react';
...
interface FlightScheduleProps extends SharedData {
...
export default function FlightSchedule({ flights, currentPage, lastPage, total }: FlightScheduleProps) {
    const handlePageChange = (page: number) => {
        router.visit(`/flight-schedule?page=${page}`, {
            preserveState: true,
            preserveScroll: true,
        });
    };
                ...
                <section className="rounded-3xl border border-slate-200 bg-white shadow-lg">
                    <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 px-6 py-4">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <h1 className="text-2xl font-bold text-slate-900">Flight Schedule</h1>
                                <p className="text-sm text-slate-600">Showing {flights.length} of {total} flights</p>
                            </div>
                        </div>
